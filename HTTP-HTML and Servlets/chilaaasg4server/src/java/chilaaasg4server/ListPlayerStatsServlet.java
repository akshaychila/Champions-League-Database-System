 ...
 * @author achila
 */
@WebServlet(name = "ListPlayerStatsServlet", urlPatterns = {"/ListPlayerStats"})
public class ListPlayerStatsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<String> l = db.ListPlayerStats(pid);
